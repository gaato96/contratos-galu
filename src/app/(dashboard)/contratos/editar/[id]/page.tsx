...
import { updateContractAction, getContractForEdit } from "@/app/actions/contracts";
      ...
      try {
        ...
        if (contract) {
          ...
          if (ver) {
            ...
            if (ver.content?.sections) {
              setSections(ver.content.sections);
            }
          }
        }
      } catch (e) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12 animate-in fade-in duration-500">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-[var(--color-brand-navy)]">Editar Contrato</h1>
          <p className="text-[var(--color-text-muted)] mt-1">Modifica el contrato antes de enviarlo al cliente.</p>
        </div>
